...
/* https://profglobal.top/wp-content/plugins/contact-form-7/includes/js/scripts.js */
try{
...
/* https://profglobal.top/wp-content/themes/allium/js/enquire.js */
try{
/*!
...
/* https://profglobal.top/wp-content/themes/allium/js/fitvids.js */
try{
/*!
* FitVids 1.1
*
...
/* https://profglobal.top/wp-content/themes/allium/js/hover-intent.js */
try{
...
/* https://profglobal.top/wp-content/themes/allium/js/superfish.js */
try{
...
/* https://profglobal.top/wp-content/themes/allium/js/custom.js */
try{
'use strict';
/*!
 * Custom v1.0
...
/* https://profglobal.top/wp-content/plugins/social-icons-widget-by-wpzoom/assets/js/social-icons-widget-frontend.js */
try{
jQuery(document).ready(function($){$('.zoom-social_icons-list__link').on({'mouseenter':function(e){e.preventDefault();var $this=$(this).find('.zoom-social_icons-list-span');var $rule=$this.data('hover-rule');var $color=$this.data('hover-color');if($color!==undefined){$this.attr('data-old-color',$this.css($rule));$this.css($rule,$color)}},'mouseleave':function(e){e.preventDefault();var $this=$(this).find('.zoom-social_icons-list-span');var $rule=$this.data('hover-rule');var $oldColor=$this.data('old-color');if($oldColor!==undefined){$this.css($rule,$oldColor)}}})});

}
catch(e){console.error("An error has occurred: "+e.stack);}
/* https://profglobal.top/wp-content/plugins/super-socializer/js/front/social_login/general.js */
try{
...
/* https://profglobal.top/wp-content/plugins/super-socializer/js/front/sharing/sharing.js */
try{
...
/* https://profglobal.top/wp-content/plugins/enlighter/resources/enlighterjs/enlighterjs.min.js */
try{
...
try{
!function(n,o){"undefined"!=typeof EnlighterJS?(n.EnlighterJSINIT=function(){EnlighterJS.init("pre.EnlighterJSRAW", "code.EnlighterJSRAW", {"indent":4,"ampersandCleanup":true,"linehover":true,"rawcodeDbclick":false,"textOverflow":"break","linenumbers":true,"theme":"enlighter","language":"php","retainCssClasses":false,"collapse":false,"toolbarOuter":"","toolbarTop":"{BTN_RAW}{BTN_COPY}{BTN_WINDOW}{BTN_WEBSITE}","toolbarBottom":""})})():(o&&(o.error||o.log)||function(){})("Error: EnlighterJS resources not loaded yet!")}(window,console);
}
catch(e){console.error("An error has occurred: "+e.stack);}
/* https://profglobal.top/wp-includes/js/wp-embed.min.js */
try{
