 ...
 * @version 1.0
 */
class Step_Optimize_Images extends \WBCR\Factory_Templates_131\Pages\Step_Custom {

	protected $prev_id = 'step4';
	protected $id = 'step5';
	protected $next_id = 'step6';

	public function __construct(\WBCR\Factory_Templates_131\Pages\Setup $page)
	{
